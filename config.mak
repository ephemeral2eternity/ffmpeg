...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-debug --disable-asm --disable-stripping --disable-optimizations
prefix=/usr/local
...
EXTRALIBS=-ldl -lm -pthread -lz -lrt 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
...
libavfilter_VERSION=3.63.101
libavfilter_VERSION_MAJOR=3
libavfilter_VERSION_MINOR=63
libavformat_VERSION=55.4.101
